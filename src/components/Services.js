        ...
        <div className="services">
            ...
            <div className="service-list">
                <div className="service">
                    <div className="icon" style={{ backgroundColor: '#375FC1' }}><img src="/assets/code.png" alt="Desarrollo de software" /></div>
                    <h3>Desarrollo de software</h3>
                    <p>Creamos aplicaciones web y móviles a medida para satisfacer tus necesidades</p>
                </div>
                <div className="service">
                    <div className="icon" style={{ backgroundColor: '#943F84' }}><img src="/assets/nube.png" alt="Servicios en la Nube" /></div>
                    <h3>Servicios en la Nube</h3>
                    <p>Migramos y gestionamos tus sistemas en la nube de manera segura y eficiente</p>
                </div>
                <div className="service">
                    <div className="icon" style={{ backgroundColor: '#ED1433' }}><img src="/assets/IT.png" alt="Infraestructura IT" /></div>
